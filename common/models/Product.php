 ...
 * @property int $products_available
 */
class Product extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['status', 'category_id', 'is_discount', 'type', 'products_available'], 'integer'],
            [['created', 'updated'], 'safe'],
            [['description_html', 'description'], 'string'],
            [['products_available'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'products_available' => Yii::t('app', 'Products Available'),
        ];
    }
}
