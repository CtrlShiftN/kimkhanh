        ...
        <div class="row py-5">
            <div class="col-12 col-sm-12 col-md-5 col-lg-5 p-5">
                <h2 class="border-bottom border-light py-sm-2 py-md-3 py-xl-4 fontTitle">MỘT SỐ ĐIỂM NỔI
                    BẬT</h2>
                <p>Những con số ấn tượng được tích lũy, duy trì từ rất nhiều năm cố gắng xây dựng, phát
            ...
            <div class="col-12 col-sm-12 col-md-7 col-lg-7 row py-5 px-5">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex align-items-center border-bottom border-right borderPoint">
                    <h1 class="mr-2"><span class='numscroller' data-slno='1' data-min='0' data-max='93' data-delay='1'
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex align-items-center border-bottom border-light border-left borderPoint">
                    <h1 class="mr-2"><span class='numscroller' data-slno='1' data-min='0' data-max='25' data-delay='1'
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex align-items-center border-top border-right border-light borderPoint">
                    <h1 class="mr-2"><span class='numscroller' data-slno='1' data-min='0' data-max='20' data-delay='1'
                                           data-increment="1">0</span><span>+</span></h1>
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex align-items-center border-top border-left borderPoint">
                    <h1 class="mr-2"><span class='numscroller' data-slno='1' data-min='0' data-max='50' data-delay='1'
...
<div class="row p-5 optimal-background row-full" id="optimal">
    ...
    <h2 class="d-none d-lg-block col-12 text-center text-light text-uppercase mt-3" id="moreOptimal">Bạn muốn biết thêm?
        Thật dễ
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active text-center">
                                <img src="<?= $cdnUrl ?>/img/introduction/avatar-1.jpg" alt=""
                                     class="center-block team">
                                <h3>Alamin Musa</h3>
                                <h4>BackEnd Developer</h4>
                                <p>"Tốc độ ổn định dù đang ở cách xa nhà, hình ảnh rõ ràng. Mạnh dạn là
                                    khách cứng của shop..."</p>
                            </div>
                            <!-- Item-2 -->
                            <div class="carousel-item text-center">
                                <img src="<?= $cdnUrl ?>/img/introduction/avatar-2.jpg" alt=""
                                     class="center-block team">
                            ...
                            <!-- Item-3 -->
                            <div class="carousel-item text-center">
                                <img src="<?= $cdnUrl ?>/img/introduction/avatar-3.jpg" alt=""
                                     class="center-block team">
                                <h3>William Karma</h3>
                                <h4>CEO</h4>
                                <p>"Thang máy của shop lắp cho công của ty tôi được gần 10 năm mà tôi chưa cần
                                    thuê nhân viên sửa chữa hỏng hóc lần nào. Đáng đồng tiền thực sự."</p>
                            </div>
        ...
        <div class="cd-testimonials-all-wrapper">
            <ul class="d-flex justify-content-center align-items-center">
                ...
                <li class="cd-testimonials-item">
                    <p>"Tốc độ ổn định dù đang ở cách xa nhà, hình ảnh rõ ràng. Mạnh dạn là khách cứng
                        của shop..."</p>
...
<div class="row m-0 text-muted">
    <h2 class="text-danger text-center col-12 p-5 font-weight-bold fontTitle border-bottom border-danger">ĐỐI TÁC CỦA
        CHÚNG TÔI</h2>
